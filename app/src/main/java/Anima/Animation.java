...
public class Animation {
    ...
    private ArrayList<FrameIMG> frameImages;
    ...
    public Animation(){
        ...
        frameImages = new ArrayList<FrameIMG>();
    ...
    public Animation(Animation animation){
        ...
        frameImages = new ArrayList<FrameIMG>();
        for(FrameIMG f : animation.frameImages){
            frameImages.add(new FrameIMG(f));
        }
    }
    ...
    public void add(FrameIMG frameImage, double timeToNextFrame){
