...
public class YellowFlowerBullet extends Bullet{
    ...
    public YellowFlowerBullet(float x, float y,
            WorldState gameWorld) {
        super(x, y, 30, 30, 1.0f, 10, gameWorld);
        //TODO Auto-generated constructor stub
        forwardBulletAnim = Loader_CacheData.getInstance().getAnimation("yellow_flower_bullet");
            backBulletAnim = Loader_CacheData.getInstance().getAnimation("yellow_flower_bullet");
