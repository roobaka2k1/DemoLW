...
import State.WorldState;
public abstract class PartiObject extends GObject{
    ...
    public PartiObject(float x, float y, float width, float height, float mass, int blood, WorldState gameWorld) {
        super(x, y, gameWorld);
