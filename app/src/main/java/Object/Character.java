...
public abstract class Character extends PartiObject
{

    public Character(float x, float y, float width, float height, float mass, int blood, WorldState gameWorld) {
